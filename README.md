...
## Lisp support
To support the machine, the following Lisp functions have been approximatively implemented: cons, car, cdr, rplaca (setf (car ...) ...), rplacd (setf (cdr ...) ...) (not actually used), print(value), print(pair), read(value), and read(pair).
